...
function (_React$Component) {
  ...
  _createClass(Application, [{
    ...
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("h1", null, "Hello from our first React App!"), _react.default.createElement("button", {
        onClick: this.fetchData
      }, "Fetch Attendees"), _react.default.createElement("ul", null, this.state.attendees.map(function (el) {
        return _react.default.createElement("li", null, el.name, " - ", _react.default.createElement("a", {
          href: el.website
        }, "Website"));
      })));
    }
    ...
    value: function fetchData() {
      ...
      fetch('/gerlent').then(function (response) {
...
_reactDom.default.render(_react.default.createElement(Application, null), document.getElementById('app'));
